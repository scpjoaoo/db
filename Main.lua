...
local GuiModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/scpjoaoo/db/main/GuiModule.lua"))()
local ParryLogic = loadstring(game:HttpGet("https://raw.githubusercontent.com/scpjoaoo/db/main/ParryLogic.lua"))()
